...
export const AgentKindSchema = z.enum(["claude", "codex", "gemini", "aider", "shell", "mock"]);
...
export const RunnerEventSchema = z.discriminatedUnion("type", [
  ...
  z.object({ type: z.literal("error"), sessionId: z.string().optional(), message: z.string(), code: z.string().optional() })
]);
